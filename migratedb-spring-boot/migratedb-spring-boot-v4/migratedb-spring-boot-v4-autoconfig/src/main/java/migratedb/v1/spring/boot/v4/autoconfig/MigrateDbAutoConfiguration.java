...
public class MigrateDbAutoConfiguration {
    ...
    public MigrateDbExecution migrateDbExecution(ObjectProvider<MigrateDbProperties> migrateDbProperties) {
        var properties = migrateDbProperties.getIfUnique();
        boolean repairOnMigrate = properties == null || properties.isRepairOnMigrate();
        return new DefaultMigrateDbExecution(repairOnMigrate);
    }
