 ...
 * @author Daniel Huss
 */
public class MigrateDbProperties<DS> {
    ...
    /**
     * Whether the autoconfiguration should also load extensions from the {@link ServiceLoader} facility.
     * Disabled by default, so only beans that implement {@link MigrateDbExtension} will be
     * loaded.
     */
     ...
     */
    private @Nullable DS dataSource;
     ...
     * interval between connect retry to the value provided. Default unit: Seconds
     */
    ...
    public @Nullable DS getDataSource() {
        return dataSource;
    }

    public void setDataSource(@Nullable DS dataSource) {
