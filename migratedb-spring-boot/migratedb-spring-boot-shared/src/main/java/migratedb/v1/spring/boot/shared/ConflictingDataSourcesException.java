...
public class ConflictingDataSourcesException extends BeanCreationException {

    public ConflictingDataSourcesException(List<String> conflictingDataSourcesDescriptions) {
