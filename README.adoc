...
image:https://img.shields.io/maven-central/v/de.unentscheidbar/migratedb-core.svg?label=Maven%20Central&style=flat[Maven Central,link=https://mvnrepository.com/artifact/de.unentscheidbar/migratedb-core/0.2.0]
...
New features must fit reasonably within the scope of a database schema migration _library_, and have to be requested by
