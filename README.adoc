...
New features are unlikely to be added, unless they are requested by a large number (>1) of users.
...
This project was forked from Flyway 7.15. There is no affiliation whatsoever between this project and the owners of the Flyway trademark.
