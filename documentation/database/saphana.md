...
- SAP HANA DDL can be used unchanged in a MigrateDB migration.
- Any SAP HANA sql script executed by MigrateDB, can be executed by SAP HANA (after the placeholders have been replaced)
  .
