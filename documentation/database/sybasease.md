...
- DDL exported by Sybase ASE Client can be used unchanged in a MigrateDB migration.
- Any Sybase ASE Server sql script executed by MigrateDB, can be executed by Sybase Interactive SQL client, Sybase
  Central and
...
- No Support for <code>migratedb.schemas</code> due to Sybase ASE limitations.
