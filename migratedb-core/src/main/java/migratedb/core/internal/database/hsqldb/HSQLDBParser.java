...
public class HSQLDBParser extends BaseParser {
    ...
    throws IOException {
        ...
        String previousKeywordText =
            previousKeyword != null ? previousKeyword.getText().toUpperCase(Locale.ENGLISH) : "";
        ...
        if ("BEGIN".equalsIgnoreCase(keywordText)
            ...
            context.increaseBlockDepth(keywordText);
                   ...
                   && previousKeyword != null && "FOR".equalsIgnoreCase(previousKeywordText) &&
