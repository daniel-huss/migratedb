 ...
 */
package migratedb.core.internal.scanner;
...
import migratedb.core.internal.scanner.android.AndroidScanner;
import migratedb.core.internal.scanner.classpath.ClassPathScanner;
import migratedb.core.internal.scanner.classpath.ResourceAndClassScanner;
import migratedb.core.internal.scanner.filesystem.FileSystemScanner;
...
public class Scanner<I> implements ResourceProvider, ClassProvider<I> {
    private static final Log LOG = Log.getLog(Scanner.class);
        ...
        for (Location location : locations) {
            if (location.isFileSystem()) {
                ...
                ResourceAndClassScanner<I> resourceAndClassScanner = android
                                                                     ? new AndroidScanner<>(implementedInterface,
                                                                                            classLoader,
                                                                                            encoding,
                                                                                            location)
                                                                     : new ClassPathScanner<>(implementedInterface,
                                                                                              classLoader,
                                                                                              encoding,
                                                                                              location,
                                                                                              resourceNameCache,
