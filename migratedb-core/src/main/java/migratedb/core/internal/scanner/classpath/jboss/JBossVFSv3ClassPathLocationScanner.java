...
import migratedb.core.internal.scanner.classpath.ClassPathLocationScanner;
...
public class JBossVFSv3ClassPathLocationScanner implements ClassPathLocationScanner {
    private static final Log LOG = Log.getLog(JBossVFSv3ClassPathLocationScanner.class);
