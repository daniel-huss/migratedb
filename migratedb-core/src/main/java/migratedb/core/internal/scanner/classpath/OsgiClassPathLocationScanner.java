 ...
 *
 * <p>
 * The resources that this scanner returns can only be loaded if MigrateDB 's ClassLoader has access to the bundle that
...
public class OsgiClassPathLocationScanner implements ClassPathLocationScanner {
    ...
    // #2198: Felix 6.0+ uses a "host" like e3a74e5a-af1f-46f0-bb53-bc5fee1b4a57_145.0 instead, where 145 is the
    // bundle id.
    ...
    static long hostToBundleId(String host) {
        ...
        throw new MigrateDbException("There's no bundleId in passed URL");
    }
