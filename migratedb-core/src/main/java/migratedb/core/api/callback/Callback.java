...
public interface Callback {
     ...
     * statements are executed should this return {@code false}. This method is called before {@link #handle(Event,
     * Context)} in order to determine in advance whether a transaction can be used or not.
     *
     * @param event   The event to check.
     * @param context The context for this event.
     *
