...
public abstract class Location {
    ...
    /**
     * The inverse of {@link #parse(String, ClassLoader)}.
     */
    @Override
    ...
    public static final class ClassPathLocation extends Location {
        ...
        private List<String> readLines(String relativeResourceName) {
            ...
            try {
                for (var resource : Collections.list(classLoader.getResources(namePrefixWithTrailingSlash + relativeResourceName))) {
        ...
        public boolean equals(Object o) {
            ...
            return namePrefixWithTrailingSlash.equals(other.namePrefixWithTrailingSlash) && classLoader.equals(other.classLoader);
        }

        @Override
        public int hashCode() {
            return Objects.hash(namePrefixWithTrailingSlash, classLoader);
        }
