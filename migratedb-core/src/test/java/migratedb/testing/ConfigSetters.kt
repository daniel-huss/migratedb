...
object ConfigSetters {
    ...
    val callbacks = Setter("setCallbacks", Arbitraries.ofSuppliers(::MyNoOp).array(Callback::class))
    val callbacksAsClassNames = Setter("setCallbacksAsClassNames", just(MyNoOp::class.java.name).array(String::class))
    ...
    val dryRunOutput = Setter("setDryRunOutput", just(MyOutputStreamFactory()))
    ...
    val javaMigrations = Setter("setJavaMigrations", Arbitraries.of(MyNoOp()).array(JavaMigration::class))
    ...
    val resolvers = Setter("setResolvers", just(MyNoOp()).array(MigrationResolver::class))
    val resolversAsClassNames = Setter("setResolversAsClassNames", just(MyNoOp::class.java.name).array(String::class))
