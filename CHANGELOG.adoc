...
== https://mvnrepository.com/artifact/de.unentscheidbar/migratedb-core/1.0.0[1.0.0] - unreleased
...
* 🔥 Renamed internal `Connection` API to `Session`.
...
* 🔥 Removed broken and unused constructor in `MigrationState`.
