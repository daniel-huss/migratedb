...
== https://mvnrepository.com/artifact/de.unentscheidbar/migratedb-core/1.6.0[1.6.0] - 2026-06-23

=== Added

* Support for Spring Boot 4

* Tests/support for database versions:
** PostgreSQL v18, v19 (Beta)
** H2 v2.4
** MariaDB v12, v13
** MySQL v9.7
** SQLite v3.53.2
...
* Updated Spring Boot 3 autoconfiguration environment to 3.5.15.

=== Removed

* Support for CockroachDB (due to license) ¯\(ツ)/¯

== https://mvnrepository.com/artifact/de.unentscheidbar/migratedb-core/1.5.0[1.5.0] - 2025-07-06

=== Changed

* *Fixed a bug that prevented discovery of SQL baseline script resources.*
* Fixed a bug where multiple `migratedb.v1.core.api.callback.Event` enum constants had the same ID (`afterInfoOperationFinish`)
* Updated build-time dependencies.
* Updated Spring Boot autoconfiguration environment to 3.5.3.

== https://mvnrepository.com/artifact/de.unentscheidbar/migratedb-core/1.4.1[1.4.1] - 2025-02-05

=== Changed

* Updated build-time dependencies.
* Updated Spring Boot autoconfiguration environment to 3.4.2.
* Fixed a typo in the liberate-on-migrate log statement.
